...
{
    public partial class VStoreWithAddressesConfiguration : IEntityTypeConfiguration<VStoreWithAddresses>
    {
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<VStoreWithAddresses> entity);
    }
}
